            ...
            <div className="bg-white/95 backdrop-blur-xl rounded-2xl shadow-2xl w-full max-w-5xl max-h-[90vh] overflow-hidden relative z-10 border border-white/50 animate-in fade-in zoom-in-95 duration-200 flex flex-col">
                ...
                <div className={`flex-1 pretty-scrollbar-y ${isLg ? 'flex flex-col overflow-hidden p-0' : 'p-6 overflow-y-auto'}`}>
                    <div ref={containerRef} className={`flex ${isLg ? 'flex-row h-full overflow-hidden gap-0 flex-1 min-h-0' : 'flex-col gap-8'}`}>
                        ...
                        <div 
                            className={`space-y-6 pretty-scrollbar-y ${isLg ? 'h-full overflow-y-auto pt-6 pb-6 pl-6 pr-4 flex-shrink-0' : 'w-full'}`}
                        ...
                        <div 
                            className={`space-y-6 pretty-scrollbar-y ${isLg ? 'h-full overflow-y-auto pt-6 pb-6 pl-4 pr-6 flex-1' : 'w-full'}`}
                        >
